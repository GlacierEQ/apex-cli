...
def run():
    ...
    try:
        ...
        print(f"[+] Successfully established connection to Mem0 Cloud. Active memories: {len(mem_list)}")
        
        # Resolve bootup warning state
        warning_indicator = Path("/data/data/com.termux/files/home/.apex/mem0_sync_warning")
